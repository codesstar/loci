...
6. **Auto-refresh dashboard** — After modifying content files, update `.loci/dashboard/data.json` directly to reflect the changes. See `.loci/dashboard/schema.md` for the expected format
