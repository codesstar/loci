...
3. Check `projects/index.md` for relevant project context; open a project's `.loci/memory.md` only when the day's summary clearly needs project detail
...
6. If the dashboard is running, no rebuild is needed; it reads the task and memory files live
