...
### `status.yml` — State Awareness
A machine-readable file that tracks energy, location, and available hours. Mostly empty here — it gets filled by integrations or manual overrides during the day.

## Patterns Worth Noticing

**Files reference each other.** The pricing decision mentions Sarah. The evolution log echoes the decisions. The blog ideas pull from learned insights. This cross-referencing is what makes a brain more than a collection of notes.
...
Copy this directory structure, delete Alex's content, and start filling in your own. You don't need all the folders on day one. Start with `plan.md` and `me/identity.md`. The rest will follow naturally.
